  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 p-6 bg-gray-50 min-h-screen">
      <div className={cardClasses + " border-gray-200"}>
        ...
        <span className="pt-6 mt-4 text-8xl col-span-1 sm:col-span-2 md:col-span-3 flex justify-center items-center" ><i class="fa-solid fa-chart-simple"></i></span>
      </div>
      ...
      <div className={cardClasses + " border-gray-200"}>
        ...
        <span className="pt-6 mt-4 text-8xl col-span-1 sm:col-span-2 md:col-span-3 flex justify-center items-center" ><i class="fa-solid fa-bars-progress"></i></span>
      </div>
